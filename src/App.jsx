        ...
        <div className="container mx-auto px-4 py-5 flex justify-between items-center">
          <div className="flex items-center">
            <img 
              ...
              alt="Logo CVClean" 
              className="h-16 w-auto"  // Made the logo taller while maintaining aspect ratio
            />
          </div>
          <button 
              ...
              {filteredTemplates.map((template) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-6">
                      <button className="w-full py-3 px-4 bg-blue-800 hover:bg-blue-900 text-white font-medium rounded-md transition-colors duration-300 shadow-sm transform hover:-translate-y-0.5">
